...
?>
  ...
  <main>
      <center>
          ...
          <div class="section"></div>
          <h2 class="light-blue-text">Admin panel</h2>
          <h5 class="light-blue-text"></h5>
          <div class="section"></div>
                  ...
                  <form class="col s12" method="post">
                      ...
                      <div class='row'>
                          ...
                          <label style='float: right;'>
                              <a class='light-blue-text' href='index.php'><b>Normalni uporabnik</b></a>
                          </label>
                      </div>
...
if(isset($_SESSION['email']))
{
    ...
    if (isset($_POST['email'], $_POST['password'])) {
        ...
        $req = mysqli_query($mysqli, 'select geslo,id_user,admin from uporabnik where email="' . $email . '"');
        ...
        if ($dn['geslo'] == $password and $password != "") {
            ...
            if($dn['admin'] == 1)
                Redirect('/ST_imenik/code/imenik/imenik.php');
            else
                echo '<div class="message">NISTE ADMIN! </div>';
        } else {
            $form = true;
